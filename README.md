...
| [Claude/Codex YouTube Video Editor](media/kits/claude-codex-youtube-video-editor) | YouTube production pipeline | Turns a raw talking-head recording into a cut, code-built visuals, clean audio, SFX, packaging, and a YouTube draft | Included submodule · [Source](https://github.com/hassancs91/claude-youtube-editor) |
...
| [YouTube Growth OS](skills/youtube-growth-os.md) | Creator operating system | Local-first multi-channel YouTube optimization, experiments, transcripts, Clips, Shorts, and durable workflow history | Private source · [Authenticated companion](https://youtube-growth-os-docs.mikefilsaime.chatgpt.site) |
